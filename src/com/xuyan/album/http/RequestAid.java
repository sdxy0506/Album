...
public class RequestAid {
	...
	private static MyParameters mRequestHeader = new MyParameters();
	...
	public static void setHeader(String httpMethod, HttpUriRequest request,
			MyParameters authParam, String url) throws SrxMobileException {
	...
	public static boolean isBundleEmpty(MyParameters bundle) {
	...
	public static UrlEncodedFormEntity getPostParamters(Bundle bundle)
		...
		try {
			...
			throw new SrxMobileException(e);
		}
	}
	...
	public static String openUrl(Context context, String url, String method,
			MyParameters params) throws SrxMobileException {
	...
	public static String openUrl(Context context, String url, String method,
			MyParameters params, String file, MobileFileType type)
			throws SrxMobileException {
		String result = "";
		try {
			...
			if (statusCode != 200) {
				...
				throw new SrxMobileException(String.format(err), errCode);
			}
			// parse content stream from response
			result = read(response);
			Log.i("http2", url + "///" + result);
			return result;
		} catch (IOException e) {
			/**
			 * 打印异常信息
	...
	public static InputStream downloadFile(Context context, String url,
			String method, MyParameters params) throws SrxMobileException {
		try {
			HttpClient client = getNewHttpClient(context);
			HttpUriRequest request = null;
			if (method.equals("GET")) {
	 ...
	 */
	private static String read(HttpResponse response) throws SrxMobileException {
		String result = "";
	...
	public static void setRequestHeader(MyParameters params) {
